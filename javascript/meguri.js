...
exports.Action = function ()
{
    ...
    let left_images = $h.new_image_list("meguriL1bottom",
                                       "meguriL2bottom",
                                       "meguriL3bottom");
    let right_images = $h.new_image_list("meguriR1bottom",
                                        "meguriR2bottom",
                                        "meguriR3bottom");

    let anime = {
        top: new $s.Anime(370, "top_l"),
        bottom: new $s.Anime(70, "meguriE1bottom", "meguriE2bottom", null),
